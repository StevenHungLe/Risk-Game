...
public class TurnInCardScreen extends JPanel
{  
	...
	public TurnInCardScreen(RiskGameEngine gameEngine, Images cardCombinations)
	{
     ...
     public void initialSetup()
	{
		...
		System.out.println("innitial setup for turn-in-card screen");
     ...
     // update the info in the screen everytime the screen is loaded
	public void update()
	{
	     System.out.println("updating the turn-in-card screen for the current player");
		     ...
		     if ( event.getSource() == turnInCardsButton )
		     {
		          ...
		          // if three cards are selected and the combination is valid
                    if ( selectedThreeCards() && isCombinationValid())
                    {
                         ...
                         game.setState("placeArmiesScreen");
                    }
