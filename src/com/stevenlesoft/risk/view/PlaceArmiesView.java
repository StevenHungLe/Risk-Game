/**
 * CSCI 2120 Fall 2014
 * Risk Game Class PlaceArmiesView
 * Authors: Hung Le, Jeanne Vu 
 * Date: 11-25-2014
 **
 * Class:	PlaceArmiesView - the subView in which the player can place armies into territories
...
public class PlaceArmiesView extends View implements Observer{
	...
	public PlaceArmiesView(RiskGameEngine gameEngine, Images riskBoard){
	...
	private class ButtonHandler implements ActionListener{
		...
		public void actionPerformed (ActionEvent event)
		{
			...
			if(event.getActionCommand().equals("Place Armies") && selectedTerritory != null)
			{
				...
				{
				// switch to the next subview
					game.setState("attackView");
				}
     ...
     public void loadData()
	{
		...
		System.out.println("innitial setup for place armies view");
     ...
     // update the view's info everytime its loaded
	public void update()
	{
