...
public class FortifyView extends View{
	...
	public FortifyView(RiskGameEngine gameEngine, Images riskBoard){
	...
	private class ButtonHandler implements ActionListener{
		...
		public void actionPerformed (ActionEvent event)
		{
			...
			{
			     // switch to next player and come back to turn in card view
				game.nextPlayer();
	...
	private class ComboBoxHandler implements ActionListener{ 
     ...
     // loads necessary data for the view
	@Override
     public void loadData()
	{
		...
		System.out.println("innitial setup for fortify view");
	}

     // update each time the view is loaded
	public void update()
	{
	     System.out.println("updating the fortify view for the current player");
